...
from aggregations import count_values, count_delivery_methods, count_orders_by_status, sum_orders_by_status
...
def main():
    ...
    orders_by_status = count_orders_by_status(orders)
    sum_order_by_status = sum_orders_by_status(orders)
    delivery_methods = count_delivery_methods(orders)

    summary = {
        "total_orders": len(orders),
        "paid_orders": len(paid_orders),
        "paid_total": total,
        "sum_order_by_status": sum_order_by_status,
